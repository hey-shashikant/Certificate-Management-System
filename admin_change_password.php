...
if(isset($_POST['submit'])){
    ...
    $user_exist_query = "SELECT `admin_id`, `password` FROM `admin_login` WHERE  admin_id = '$id' ";
    $result = mysqli_query($con,$user_exist_query);
    if($result){
        if(mysqli_num_rows($result) >= 1){
            // $result_fetch = mysqli_fetch_assoc($result);
            $sql = "UPDATE `admin_login` SET `password`='$_POST[newpassword]' ";
                                        ...
                                        <?php } ?>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="form-group has-success">
                                                        <label for="success" class="control-label">Admin ID</label>
                                                		<div class="">
