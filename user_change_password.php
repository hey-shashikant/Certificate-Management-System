...
if(isset($_POST['submit'])){
    ...
    $newpasswd=$_POST['confirmpassword'];
    $user_exist_query = "SELECT `user_id`, `password` FROM `user_login` WHERE  user_id = '$id' ";
    $result = mysqli_query($con,$user_exist_query);
    if($result){
        if(mysqli_num_rows($result) >= 1){
            // $result_fetch = mysqli_fetch_assoc($result);
            $sql = "UPDATE `user_login` SET `password`='$_POST[newpassword]' ";
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">User Change Password</h2>
                                </div>
                                        ...
                                        <?php } ?>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="form-group has-success">
                                                        <label for="success" class="control-label">User ID</label>
                                                		<div class="">
                                    <input type="text" name="adminid" class="form-control" required="required" id="success">
